 ...
 */
public class ResourceType extends RequestProperty {
     ...
     */
    public ResourceType(XMLParserHandler parent) {
        super(parent);
    }
    ...
    /**
     * Returns {@link org.abstracthorizon.danube.webdav.xml.dav.response.properties.ResourceType}
     * @param adapter adapter
     * @param resource resource
     * @return {@link org.abstracthorizon.danube.webdav.xml.dav.response.properties.ResourceType}
     */
    public ResponseProperty processResponse(ResourceAdapter adapter, Object resource) {
        return new org.abstracthorizon.danube.webdav.xml.dav.response.properties.ResourceType(adapter.isCollection(resource));
    }
